...
axis1 = vm.Vector3D((0.1, 0.3, 0))
axis4 = vm.Vector3D((-0.2, 0.4, 0))

axis1.Normalize()
axis4.Normalize()

linkage1 = RevoluteLinkage(ground, vm.Point3D((-0.5*h, 0, 0)), axis1,
                           rod1,  vm.Point3D((-0.5*l1, 0, 0)), name='l1')


#linkage2 = RevoluteLinkage(rod2, vm.Point3D((-0.5*l2,0, 0)), vm.z3D,
#                           rod1, vm.Point3D((0.5*l1, 0, 0)), name='l2')
#
...
mechanism = MovingMechanism([linkage1], ground, name='3 bar')
#
