...
p3a = npy.array([0, -(r_gear_3+r_gear_4)/2, 0])
p3b = p3a + (L-0.1) * shaft_axe_1
...
bearing3a = linkages.FrictionlessBallLinkage(ground, shaft3, p3a, egs1, 'bearing 1a')
bearing3b = linkages.FrictionlessLinearAnnularLinkage(ground, shaft3, p3b, egs1, 'bearing 1b')
...
center_gearing_2 = npy.array([0, -r_gear_3, 0])
gearset31 = linkages.FrictionlessGearSetLinkage(shaft3, shaft1, center_gearing_2,
                                                  radial_vector=radial_vector,
                                                  axial_vector=axial_vector,
                                                  pressure_angle=alpha_gs1,
                                                  helix_angle=mean_spiral_angle,
                                                  name='Gear set 1')
#gearset23=linkages.GearSetLinkage(shaft2,shaft3,[3*L/2,e1*r1+(e1+e2)*(1-r1),0],dir23)

imposed_speeds = [(bearing1a, 0, w)]

load1 = loads.KnownLoad(shaft3, (-L/4)*shaft_axe_1, [0, 0, 0], [0, 0, 0], [C, 0, 0], 'input torque')
load2 = loads.SimpleUnknownLoad(shaft2, p2b + 0.1 * shaft_axe_2, egs2, [], [0], 'output torque')

mech = genmechanics.Mechanism([bearing1a, bearing1b, bearing2a, bearing2b, bearing3a, bearing3b, gearset12, gearset31],
